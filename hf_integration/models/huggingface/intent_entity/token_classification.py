#
# This file is copied from huggingface/transformers in order to patch some issues
# - Entity names that contain a "-" are truncated
# - Excessive use of .numpy() on tensorflow tensors reduce performance drastically
#
import types
import warnings
...
class TokenClassificationPipeline(Pipeline):
    ...
    def postprocess(self, model_outputs: Dict[str, any], aggregation_strategy=AggregationStrategy.NONE, ignore_labels=None):
